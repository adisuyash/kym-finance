...
contract MockAMM is ReentrancyGuard, Ownable {
   ...
   */
  function swapPTForYT(uint256 ptAmountIn, uint256 minYtOut) external nonReentrant returns (uint256 ytAmountOut) {
   ...
   */
  function swapYTForPT(uint256 ytAmountIn, uint256 minPtOut) external nonReentrant returns (uint256 ptAmountOut) {
  ...
  function getPoolInfo()
    external
    view
    returns (uint256 ptReserve_, uint256 ytReserve_, uint256 ptPrice, uint256 ytPrice)
  {
