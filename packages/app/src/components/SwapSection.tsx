...
export function SwapSection() {
  ...
  // Compute toAmount using yield-based discount factor formula
      ...
      <div className='card-body'>
        ...
        {poolInfo && poolInfo.length >= 2 && (
          <div className='grid grid-cols-2 gap-4 mb-4'>
            <div className='stat bg-base-200 rounded-lg'>
              ...
              <div className='stat-value text-sm'>{parseFloat(formatEther(poolInfo[0])).toFixed(2)}</div>
            </div>
            <div className='stat bg-base-200 rounded-lg'>
              <div className='stat-title'>YT Reserve</div>
              <div className='stat-value text-sm'>{parseFloat(formatEther(poolInfo[1])).toFixed(2)}</div>
            </div>
          </div>
        )}
        ...
        <div className='form-control'>
          <label className='label'>
            ...
            <span className='label-text-alt'>Discount Factor: DF = 1/(1+r)^t</span>
          </label>
        ...
        {fromAmount && toAmount && (
          <div className='alert alert-info'>
            ...
            <div>
              ...
              <div>
                Min received: {((parseFloat(toAmount) * (100 - parseFloat(slippage))) / 100).toFixed(6)} {toToken}
              </div>
            </div>
          </div>
        )}
        ...
        <div className='flex justify-between items-center mb-4'>
          ...
          <button className='btn btn-ghost btn-xs' onClick={() => refetchPoolInfo()} title='Refresh pool data'></button>
        </div>
          ...
          <div className='alert alert-warning mb-4'>
            <div>
              ...
              <div className='text-sm mt-1'>
                ...
                <br />
                Contact the deployer or wait for pool initialization.
              </div>
            </div>
          </div>
        )}
