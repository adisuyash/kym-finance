        ...
        {contractStats && Array.isArray(contractStats) && contractStats.length >= 4 ? (
          <div className='stats shadow mb-6 w-full'>
            ...
            <div className='stat'>
              ...
              <div className='stat-value text-accent'>{formatTimeToMaturity(contractStats[2])}</div>
              <div className='stat-desc'>{contractStats[3] ? 'Contract Expired' : 'Until PT redemption'}</div>
            </div>
          </div>
        ) : null}
