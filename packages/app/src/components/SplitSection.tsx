...
export function SplitSection() {
  ...
  const hasSufficientAllowance = currentAllowance && splitAmount ? currentAllowance >= requiredAmount : false
  ...
  const pricing = calculateYieldPricing(splitAmount ? parseFloat(splitAmount) : 0)
      ...
      <div className='card-body'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-4'>
          ...
          <div className='stat bg-secondary/10 rounded-lg'>
            ...
            <div className='stat-desc text-xs'>{ytError ? '❌ Error' : contracts.yieldToken.slice(0, 8) + '...'}</div>
          </div>
        </div>
          ...
          <div className='grid grid-cols-2 gap-4 mb-4'>
            ...
            <div className='card bg-secondary/10 border border-secondary/20'>
              <div className='card-body p-4'>
                ...
                <div className='text-sm opacity-70'>Earns yield until maturity (~5% APY)</div>
              </div>
            </div>
          </div>
        )}
        ...
        {splitAmount && parseFloat(splitAmount) > 0 && (
          <div className='alert alert-success mb-4'>
            ...
            <div>
              <div className='font-bold'>Yield-Based Pricing Breakdown</div>
              <div>
                PT Discount: {((1 - expectedPT / (splitAmount ? parseFloat(splitAmount) : 1)) * 100).toFixed(1)}% | YT
                Premium: {((expectedYT / (splitAmount ? parseFloat(splitAmount) : 1)) * 100).toFixed(1)}%
              </div>
            </div>
          </div>
        )}
        ...
        <div className='collapse collapse-arrow bg-base-200 mt-4'>
          <input type='checkbox' />
          <div className='collapse-title text-sm font-medium'>💡 Learn more about yield splitting</div>
          <div className='collapse-content text-sm'>
            <div className='space-y-2'>
              ...
              <p>
                <strong>Yield Tokens (YT):</strong> Represent the yield-earning rights. Accumulate yield over time based
                on the underlying asset&apos;s performance.
              </p>
              <p>
                <strong>Benefits:</strong> Trade yield separately from principal, optimize your risk/reward profile, or
